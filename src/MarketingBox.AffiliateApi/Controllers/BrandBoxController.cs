...
namespace MarketingBox.AffiliateApi.Controllers
{
    ...
    public class BrandBoxController : ControllerBase
    {
        ...
        {
            var response = await _brandBoxService.DeleteAsync(new BrandBoxByIdRequest {BrandBoxId = brandBoxId});
        ...
        {
            var response = await _brandBoxService.GetAsync(new BrandBoxByIdRequest {BrandBoxId = brandBoxId});
            return this.ProcessResult(response, _mapper.Map<BrandBoxModel>(response.Data));
        }
    }
}