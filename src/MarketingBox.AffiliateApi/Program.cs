...
using MarketingBox.AffiliateApi.Settings;
...
namespace MarketingBox.AffiliateApi
{
    ...
    {
        public const string SettingsFileName = ".marketingboxaffiliateapi";
        ...
        {
            Console.Title = "MarketingBox.AffiliateApi";

            Settings = SettingsReader.GetSettings<SettingsModel>(SettingsFileName);

            using var loggerFactory = LogConfigurator.ConfigureElk_v2("MarketingBox.AffiliateApi", Settings.SeqServiceUrl, Settings.ElkLogs);
